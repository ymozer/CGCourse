...
class Chapter02_5_Application : public Base::Application
{
public:
    Chapter02_5_Application() : Application("Chapter 2.5: An Efficient Square (EBO)") {}
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        auto app = std::make_unique<Chapter02_5_Application>();
        app->run();
    }
