...
{
    LOG_INFO("Chapter 13 constructed in STANDALONE mode.");
}
#else
Chapter13_Application::Chapter13_Application()
    : ChapterBase() // Calls IChapter constructor
{
    LOG_INFO("Chapter 13 constructed in BUNDLED mode.");
}
#endif

void Chapter13_Application::setup()
{
...
void Chapter13_Application::render()
{
...
void Chapter13_Application::renderChapterUI()
{
...
void Chapter13_Application::handleInput(float deltaTime)
{
}
void Chapter13_Application::update(float deltaTime)
{
...
void Chapter13_Application::setupCube()
{
    //clang-format off
    float vertices[] = {
...
void Chapter13_Application::setupCoordinateGuide()
{
...
void Chapter13_Application::drawMouseCapturePopup()
{
