...
Chapter18_Application::Chapter18_Application(std::string title, int width, int height)
...
#else
Chapter18_Application::Chapter18_Application()
    : ChapterBase()
{
...
#endif
Chapter18_Application::~Chapter18_Application() = default;

void Chapter18_Application::setup()
{
...
void Chapter18_Application::setupScene()
{
...
void Chapter18_Application::setupShaders()
{
    m_Shader = std::make_unique<Base::Shader>();
    m_Shader->loadFromFile("shaders/Chapter18.vert", "shaders/Chapter18.frag");
...
void Chapter18_Application::setupGeometry()
{
    setupCube();
    setupLightCube();
...
void Chapter18_Application::setupCamera()
{
...
void Chapter18_Application::setupEventListeners()
{
    auto &app = Base::Application::getInstance();
...
void Chapter18_Application::shutdown()
{
    auto &app = Base::Application::getInstance();
...
void Chapter18_Application::render()
{
...
void Chapter18_Application::renderChapterUI()
{
...
void Chapter18_Application::handleInput(float deltaTime) {}

void Chapter18_Application::update(float deltaTime)
{
    bool reloaded = false;
...
void Chapter18_Application::setupCube()
{
...
void Chapter18_Application::setupLightCube()
{
...
void Chapter18_Application::setupCoordinateGuide()
{
    float guideVertices[] = {
...
void Chapter18_Application::drawMouseCapturePopup()
{
...
void Chapter18_Application::rebindShaderUniformBlocks()
{
